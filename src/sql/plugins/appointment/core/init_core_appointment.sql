...
('APPOINTMENT_MANAGEMENT','appointment.adminFeature.ManageAppointment.name',1,'jsp/admin/plugins/appointment/ManageAppointments.jsp','appointment.adminFeature.ManageAppointment.description',0,'appointment',NULL,NULL,NULL,4);


--
-- Data for table core_user_right
--
DELETE FROM core_user_right WHERE id_right = 'APPOINTMENT_MANAGEMENT';
INSERT INTO core_user_right (id_right,id_user) VALUES ('APPOINTMENT_MANAGEMENT',1);
