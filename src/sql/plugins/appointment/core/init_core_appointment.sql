...
INSERT INTO core_admin_right (id_right,name,level_right,admin_url,description,is_updatable,plugin_name,id_feature_group,icon_url,documentation_url, id_order ) VALUES 
('APPOINTMENT_CALENDAR_TEMPLATE','appointment.manageCalendarTemplates.title',0,'jsp/admin/plugins/appointment/ManageCalendarTemplates.jsp','appointment.manageCalendarTemplates.title',0,'appointment','APPLICATIONS',NULL,NULL,5);
