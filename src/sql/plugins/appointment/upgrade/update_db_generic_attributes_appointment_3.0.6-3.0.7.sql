...
-- changeset appointment:update_db_generic_attributes_appointment_2.0.0-2.4.3.sql logicalFilePath:sql/plugins/genericattributes/upgrade/update_db_generic_attributes_appointment_2.0.0-2.4.3.sql
