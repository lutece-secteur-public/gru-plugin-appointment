...
public final class WorkingDayService {
	...
	public static void generateWorkingDayAndListTimeSlot(int nIdWeekDefinition, DayOfWeek dayOfWeek,
		...
		TimeSlotService.createListTimeSlot(TimeSlotService.generateListTimeSlot(workingDay.getIdWorkingDay(),
				startingTime, endingTime, nDuration, nMaxCapacity, Boolean.FALSE));
	}
	...
	/**
	 * Find the working day in a list of working day which matches the day of
	 * week given
	 * 
	 * @param listWorkingDay
	 *            the list of working days
