...
public class WorkingDayHome {
	 ...
	 * 
	 * @param workingDay
	 *            The instance of the WorkingDay which contains the
	 *            informations to store
	 * @return The instance of the WorkingDay which has been created with
	 *         its primary key.
	 */
	...
	/**
	 * Returns an instance of the WorkingDay whose identifier is specified
	 * in parameter
	 * 
	 * @param nKey
