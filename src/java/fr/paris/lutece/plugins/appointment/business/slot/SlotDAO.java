...
public final class SlotDAO extends UtilDAO implements ISlotDAO {
	...
	private static final String SQL_QUERY_SELECT_SLOT_WITH_MAX_DATE = SQL_QUERY_SELECT_COLUMNS 
			+ ", MAX(slot.starting_date_time) FROM appointment_slot slot"			
			+" WHERE slot.id_form = ?";
	...
	@Override
	public List<Slot> findByIdFormAndDateRange(int nIdForm, LocalDateTime startingDateTime,
