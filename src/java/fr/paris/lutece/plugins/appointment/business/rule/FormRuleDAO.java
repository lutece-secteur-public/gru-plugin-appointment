...
public class FormRuleDAO implements IFormRuleDAO {
	...
	private static final String SQL_QUERY_INSERT = "INSERT INTO appointment_form_rule (id_form_rule, is_captcha_enabled, is_mandatory_email_enabled, nb_days_before_new_appointment, min_time_before_appointment, id_form) VALUES (?, ?, ?, ?, ?, ?)";
	private static final String SQL_QUERY_UPDATE = "UPDATE appointment_form_rule SET is_captcha_enabled = ?, is_mandatory_email_enabled = ?, nb_days_before_new_appointment = ?, min_time_before_appointment = ?, id_form = ? WHERE id_form_rule = ?";
	private static final String SQL_QUERY_DELETE = "DELETE FROM appointment_form_rule WHERE id_form_rule = ?";
	private static final String SQL_QUERY_SELECT_COLUMNS = "SELECT id_form_rule, is_captcha_enabled, is_mandatory_email_enabled, nb_days_before_new_appointment, min_time_before_appointment, id_form FROM appointment_form_rule";
