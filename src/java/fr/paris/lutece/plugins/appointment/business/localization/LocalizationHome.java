...
public class LocalizationHome {
	 ...
	 * 
	 * @param localization
	 *            The instance of the Localization which contains the
	 *            informations to store
	 * @return The instance of Localization which has been created with its
	 *         primary key.
	 */
	 ...
	 * 
	 * @param localization
	 *            The instance of the Localization which contains the data to
	 *            store
	...
	/**
	 * Returns an instance of the Localization whose identifier is specified in
	 * parameter
	 * 
	 * @param nKey
